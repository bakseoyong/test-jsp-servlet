package com.example.testjspservlet.DAO;
...
public class BDao {
    ...
    public BDto getContentView(String str){
        ...
        try {
            ...
            String query = "select bId, bName, bTitle, bContent, bHit" +
    ...
    public void reply_view(String str){
        BDto dto = null;
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
